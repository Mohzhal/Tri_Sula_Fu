        ...
        <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
          <div class="mx-auto max-w-5xl">
            ...
            <div class="mt-6 sm:mt-8 lg:flex lg:items-start lg:gap-12">
              <form id="form_checkout" action="<?= base_url('user_function/checkout'); ?>" method="POST" class="w-full rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 sm:p-6 lg:max-w-xl lg:p-8">
                ...
                <div class="mb-6 grid grid-cols-2 gap-4">
                  <div class="col-span-2 sm:col-span-1" id="req_nama">
                    <label for="nama" class="mb-2 block text-sm font-medium text-gray-900 dark:text-white"> Full name (as displayed on card)* </label>
                  ...
                  <div class="col-span-2 sm:col-span-1" id="req_card_number">
                    <label for="card-number-input" class="mb-2 block text-sm font-medium text-gray-900 dark:text-white"> Card number* </label>
                    <input type="number" name="card_number" id="card-number-input" class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 pe-10 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500  dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-primary-500 dark:focus:ring-primary-500" placeholder="xxxx-xxxx-xxxx-xxxx" pattern="^4[0-9]{12}(?:[0-9]{3})?$" required />
                  </div>
      
                  <div id="req_card_expired">
                    ...
                    <div class="relative">
                      ...
                      <input datepicker name="card_expired" id="card-expiration-input" type="text" class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 ps-9 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500" placeholder="<?= date('d/m/Y'); ?>" required />
                    </div>
                  </div>
                  <div id="req_cvv">
                ...
                <button class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline w-full" type="button" id="btn_checkout" onclick="submit_form(this,'#form_checkout',0)">Pay Now</button>
              </form>
                ...
                <div class="space-y-4 rounded-lg border border-gray-100 bg-gray-50 p-6 dark:border-gray-700 dark:bg-gray-800">
                  <div class="space-y-2">
                    <dl class="flex items-center justify-between gap-4 border-gray-200 pt-2 dark:border-gray-700">
                      <dt class="text-base font-bold text-gray-900 dark:text-white">Buyed Product</dt>
                    </dl>
                    <?php if($cart) : ?>
                      <?php foreach($cart AS $row) : ?>
                      <dl class="flex items-center justify-between gap-4">
                        <dt class="text-base font-normal text-gray-500 dark:text-gray-400"><?= $row->nama; ?></dt>
                        <dd class="text-base font-medium text-gray-900 dark:text-white">$<?= $row->harga ?></dd>
                      </dl>
                      <?php endforeach;?>
                    <?php endif;?>
                  </div>
